INSERT INTO "public"."system_modulos_opciones_permisos" 
	   ("modulo", "modulo_tipo", "opcion_permiso_nombre", "opcion_permiso_descripcion", "opcion_permiso_defecto") 
       VALUES 
       ('AtencionVictimasAccidentes', 'app', 'sw_eliminar_circular', 'PERMITE ELIMINAR EL REGISTRO DE LA CIRCULAR.', '0');
 
UPDATE system_modulos_metodos SET sw_variables_adicionales = 1 WHERE modulo = 'AtencionVictimasAccidentes';

CREATE TABLE views_cirucular_015 ( id_view integer NOT NULL,
